...
package com.wangwei.cameragl.third.grafika;
...
public class Drawable2d {
    ...
    // 后置摄像头的采集纹理逆向旋转了90度，因此，对于纹理坐标需要做一个顺时针的90度旋转。
    private static final float FULL_RECTANGLE_BACKCAMERA_TEX_COORDS[] = {
    ...
    private static final FloatBuffer FULL_RECTANGLE_BACKCAMERA_TEX_BUF =
            GlUtil.createFloatBuffer(FULL_RECTANGLE_BACKCAMERA_TEX_COORDS);
     ...
     */
    public enum Prefab {
        TRIANGLE, RECTANGLE, FULL_RECTANGLE, FULL_RECTANGLE_BACKCAMERA
    }
    ...
    public Drawable2d(Prefab shape) {
        switch (shape) {
            ...
            case FULL_RECTANGLE_BACKCAMERA:
                mVertexArray = FULL_RECTANGLE_BUF;
                mTexCoordArray = FULL_RECTANGLE_BACKCAMERA_TEX_BUF;
                mCoordsPerVertex = 2;
                mVertexStride = mCoordsPerVertex * SIZEOF_FLOAT;
                mVertexCount = FULL_RECTANGLE_COORDS.length / mCoordsPerVertex;
                break;
