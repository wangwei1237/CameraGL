...
public class Gl2Utils {
    ...
    /**
     * 将画面的小大和当前的坐标系，做正交投影。让其显示在当前的页面中。
     * @param matrix
     * @param imgWidth
     * @param imgHeight
     * @param viewWidth
     ...
     * 翻转矩阵
     * @param m
     * @param needFlipX 翻转X轴？
     * @param needFlipY 翻转Y轴？
     * @return
     */
    public static float[] flip(float[] m,boolean needFlipX,boolean needFlipY){
        if(needFlipX||needFlipY){
            Matrix.scaleM(m,0,needFlipX?-1:1,needFlipY?-1:1,1);
        }
        return m;
    }
